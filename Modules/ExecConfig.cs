...
namespace R2DSEssentials.Modules
{
    ...
    internal sealed class ExecConfig : R2DSEModule
    {
        ...
        {
            _configFileName = AddConfig("Server CFG Filename", "server",
                "Name of the CFG File to load at the startup of the server. Don't include the extension. Example : server");
        }
